...
must_haves:
  truths:
    - "Tabele courses, course_levels, level_outcomes, chapters, user_progress, course_resources istnieja w bazie danych"
    - "RLS policies chronią dane użytkownika - użytkownik widzi tylko swoje kursy"
    - "DAL funkcje pozwalają tworzyć i pobierać kursy z zagnieżdżonymi relacjami"
  artifacts:
