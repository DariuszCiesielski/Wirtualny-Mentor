...
- W `src/components/layout/sidebar.tsx` znajdz sekcje nawigacji
- Upewnij sie ze link href="/courses" jest AKTYWNY (nie disabled)
- Jesli link jest disabled lub ma warunek disabled, usun to:
  ```typescript
  ...
  ```
- Link powinien byc opakowany w `<Link href="/courses">` z next/link
  </action>
  <verify>
- `npm run build` - brak bledow
