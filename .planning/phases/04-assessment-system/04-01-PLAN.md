...
must_haves:
  truths:
    ...
    - "Tabela quiz_attempts istnieje z tracking wyników"
    - "Tabela level_unlocks istnieje dla odblokowywania poziomów"
    - "RLS policies izoluja dane użytkowników"
    - "TypeScript types dla quiz entities są dostępne"
  artifacts:
...
<objective>
Stworzyć fundament bazodanowy i typowanie dla systemu quizów.

Purpose: Baza danych i typy są wymagane przed implementacja logiki generowania i UI.
