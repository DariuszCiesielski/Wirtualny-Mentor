...
must_haves:
  truths:
    - "AI może generować quizy z uzyciem generateObject"
    - "Quiz może byc zapisany i pobrany z bazy danych"
    - "Odpowiedzi mogą byc ewaluowane server-side"
...
<objective>
Zbudować backend dla generowania quizów przez AI i ewaluacji odpowiedzi.

Purpose: Backend jest wymagany przed UI - pozwala na generowanie i scoring quizów.
...
Prompts są w jezyku polskim (zgodnie z projektem).
  </action>
  <verify>
- Plik istnieje i eksportuje 3 prompty
- Import działa: `import { QUIZ_GENERATION_PROMPT } from '@/lib/ai/quiz/prompts'`
  </verify>
  <done>
...
- Import działa: `import { saveQuiz, getQuizByChapter } from '@/lib/dal/quizzes'`
  </verify>
  <done>
