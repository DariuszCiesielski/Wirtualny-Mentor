...
<objective>
Utworzenie schematu bazy danych dla notatek użytkownika z obsługa pgvector i tsvector.
...
- RLS policy musi sprawdzać course ownership via EXISTS
  </action>
  <verify>
...
Eksportuj wszystkie typy z pliku.
  ...
  <verify>
`npx tsc --noEmit src/types/notes.ts` - brak błędów
  </verify>
  <done>
TypeScript types dla notes dostępne do importu w calym projekcie.
  </done>
</task>
...
5. TypeScript types kompiluja się bez błędów
