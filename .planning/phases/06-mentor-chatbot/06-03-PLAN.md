...
must_haves:
  truths:
    - "Użytkownik może zadawac pytania o temat nauki"
    - "Odpowiedzi są streamowane w czasie rzeczywistym"
    - "Chat UI pokazuje wiadomosc powitalna"
    - "Użytkownik widzi loading state podczas generowania"
    - "Użytkownik może zatrzymac generowanie"
  artifacts:
